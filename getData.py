...
pl.getTable().to_csv('data/22-04-22/aftTable.csv')

pl_ = getSummary("spotify:playlist:37i9dQZF1DX4JAvHpjipBk")
pl_.getTable_().to_csv('data/22-04-22/summary.csv')

pl__ = getSpecs("spotify:playlist:37i9dQZF1DX4JAvHpjipBk")
dic = pl__.getDict()

with open('/Users/sabrinalem/Desktop/FriData_Functions/data/22-04-22/specs.json', 'w') as out:
    json.dump(dic, out)
